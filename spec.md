...
and since v0.24.0 a hearth that walks out over a grudge is no exception: it becomes one of
these agents on the spot, holding the food it took and the mood it left in.
