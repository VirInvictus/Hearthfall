...
> **Status: v0.24.0. SP 7 (composition) is complete and SP 8 (the long game) has opened: a hearth that walks out over a grudge now camps in the dark as a rival band, and comes back in arms. The militia is an assembly, the counter-web prices the mix, and a band's read goes stale behind its border.** Playable start to finish, and
